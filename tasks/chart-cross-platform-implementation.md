...
| 4 — Backend factory + integration | Not started | Blocked on Phase 3 substantially completing; see Chart doc's D2 open item — the real blocker is one level below "which backend," in `ChartImage.GetImage`'s hard GDI+-typed return contract. |
