...
*/
		...
		{
			List<Microsoft.Reporting.NETCore.Internal.Soap.ReportingServices2005.Execution.DataSourceCredentials> list = new List<Microsoft.Reporting.NETCore.Internal.Soap.ReportingServices2005.Execution.DataSourceCredentials>();
		...
		private static ReportParameterInfo SoapParameterToReportParameterInfo(Microsoft.Reporting.NETCore.Internal.Soap.ReportingServices2005.Execution.ReportParameter soapParam)
		{
			string[] array = null;
			...
			if (soapParam.ValidValues != null)
			{
				...
				Microsoft.Reporting.NETCore.Internal.Soap.ReportingServices2005.Execution.ValidValue[] validValues = soapParam.ValidValues;
				foreach (Microsoft.Reporting.NETCore.Internal.Soap.ReportingServices2005.Execution.ValidValue validValue in validValues)
				{
		...
		private static Microsoft.Reporting.NETCore.Internal.Soap.ReportingServices2005.Execution.PageCountMode SoapPageCountFromViewerAPI(PageCountMode pageCountMode)
		{
			if (pageCountMode == PageCountMode.Actual)
			{
				return Microsoft.Reporting.NETCore.Internal.Soap.ReportingServices2005.Execution.PageCountMode.Actual;
			}
			return Microsoft.Reporting.NETCore.Internal.Soap.ReportingServices2005.Execution.PageCountMode.Estimate;
		}
