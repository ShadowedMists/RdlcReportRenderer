...
| 🔵 **LOW** | IMAGE (TIFF/EMF) renderer: cross-platform support | 🔄 JPEG/PNG raster path incl. text and rich text verified working on Linux via Skia (2026-07-28); Chart/Gauge/Map embedding is a separate, not-yet-investigated gap; BMP/GIF/TIFF/EMF stay Windows-only; see `tasks/image-renderer-cross-platform.md` | MEDIUM |
