...
{
	/// <summary>Map engine Milestone A adapter — wraps <see cref="System.Drawing.Drawing2D.GraphicsPath"/> behind <see cref="IGraphicsPath"/>.</summary>
	internal sealed class GdiGraphicsPath : IGraphicsPath
	{
		...
		internal GdiGraphicsPath(GraphicsPath path)
		{
			NativePath = path;
		}
