...
namespace Microsoft.Reporting.Chart.WebForms
{
	internal class ChartGraphics : ChartGraphics3D
	{
		...
		/// <summary>
		/// Milestone E1 (2026-07-23): previously duplicated ~180 lines of concrete Brush/Pen/
		/// ImageAttributes logic identical in shape to <see cref="FillRectangleRelResource"/>;
		/// now delegates to it directly (identical param list across all overloads, so this is
		/// a pure one-line forward, same pattern as B1b's <see cref="FillRectangleAbs"/>).
		/// </summary>
		internal void FillRectangleRel(RectangleF rectF, Color backColor, ChartHatchStyle backHatchStyle, string backImage, ChartImageWrapMode backImageMode, Color backImageTranspColor, ChartImageAlign backImageAlign, GradientType backGradientType, Color backGradientEndColor, Color borderColor, int borderWidth, ChartDashStyle borderStyle, Color shadowColor, int shadowOffset, PenAlignment penAlignment, bool circular, int circularSectorsCount, bool circle3D, BarDrawingStyle barDrawingStyle, bool isVertical)
		{
			FillRectangleRelResource(rectF, backColor, backHatchStyle, backImage, backImageMode, backImageTranspColor, backImageAlign, backGradientType, backGradientEndColor, borderColor, borderWidth, borderStyle, shadowColor, shadowOffset, penAlignment, circular, circularSectorsCount, circle3D, barDrawingStyle, isVertical);
		}

		/// <summary>Interface-typed counterpart of <see cref="FillRectangleRel(RectangleF, Color, ChartHatchStyle, string, ChartImageWrapMode, Color, ChartImageAlign, GradientType, Color, Color, int, ChartDashStyle, Color, int, PenAlignment, BarDrawingStyle, bool)"/> (Milestone B2 — coexists until callers migrate; see chart-gdi-type-abstraction.md). Named distinctly since none of these overloads' parameters differ by type. Uses its own local <see cref="IPen"/>/<see cref="IBrush"/> resources via <c>resourceFactory</c> — <see cref="FillRectangleRel(RectangleF, Color, ChartHatchStyle, string, ChartImageWrapMode, Color, ChartImageAlign, GradientType, Color, Color, int, ChartDashStyle, Color, int, PenAlignment, BarDrawingStyle, bool)"/> is now a one-line forward to this method (Milestone E1, 2026-07-23).</summary>
